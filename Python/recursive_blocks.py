class Methods:
    methods = {
        ...
        "exec": lambda state_dict, methods_dict,  line, following_lines:
            Methods.exec_cmd(state_dict, methods_dict, line, following_lines)
    }
    ...
    @staticmethod
    def exec_cmd(state_dict, methods_dict, line, following_lines):
